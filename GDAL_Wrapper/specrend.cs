...
namespace GDAL_Wrapper
{
    class specrend
    {
        struct colourSystem
        {
            public colourSystem(string _name,
                double _xRed,
                double _yRed,
                double _xGreen,
                double _yGreen,
            ...
            public static colourSystem SMPTEsystem = new colourSystem("SMPTE", 0.630, 0.340, 0.310, 0.595, 0.155, 0.070, 0.3127, 0.3291, GAMMA_REC709);
        };
        ...
        */
        ...
        void upvp_to_xy(double up, double vp, ref double xc, ref double yc)
        {
        ...
        */
        ...
        void xy_to_upvp(double xc, double yc, ref double up, ref double vp)
        {
        ...
        */
        ...
        bool inside_gamut(double r, double g, double b)
        {
            return (r >= 0) && (g >= 0) && (b >= 0);
        }
        ...
        */
        ...
        void norm_rgb(ref double r, ref double g, ref double b)
        {
        ...
        */
        ...
        static double[,] cie_colour_match = new double[81, 3] {
        ...
        void spectrum_to_xyz(Func<double, double> spec_intens,//double (* spec_intens)(double wavelength)
    ...
    {
        public static Color wavelength_to_rgb(double wavelength, double gamma = 0.8)
        {
            ...
            G = G * 255;
            B = B * 255;
            return (Color.FromArgb(255, (int)Math.Floor(R), (int)Math.Floor(G), (int)Math.Floor(B)));
        }
    }
